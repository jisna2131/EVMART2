...
const BookingPageVendor = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const response = await axiosInstance.get("/cart/vendor/bookings"); // Backend route to fetch bookings
    ...
    const fetchBookingsSpare = async () => {
      try {
        const response = await axiosInstance.get("/cart/vendor/bookings/spare"); // Backend route to fetch bookings
...
export default BookingPageVendor;
